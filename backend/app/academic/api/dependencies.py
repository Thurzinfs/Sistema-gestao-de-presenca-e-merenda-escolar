...
from app.academic.infrastructure.repository import ClassroomRepository, StudentsRepository
...
class AcademicContainer(containers.DeclarativeContainer):
    ...
    classroom_register_use_case = providers.Factory(
        RegisterClassroomUsercase, classroom_repo = classroom_repo, school_repo = school_repo
        )
    ...
    classroom_update_use_case = providers.Factory(
        ClassroomUpdateUseCase, classroom_repo = classroom_repo, school_repo = school_repo
        )
    ...
    student_register_use_case = providers.Factory(
        RegisterStudentsUseCase, students_repo = students_repo, classroom_repo = classroom_repo
    )
