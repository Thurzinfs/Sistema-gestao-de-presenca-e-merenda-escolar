...
from app.presence.infrastructure.repository import FrequencyRepository, ReadingRepository, RegisterSnackRepository
...
class PresenceContainer(containers.DeclarativeContainer):
    ...
    list_all_reading_use_case = providers.Factory(
        ReadingAllUseCase, reading_repo = reading_repo
    )
    ...
    frequency_repo = providers.Factory(FrequencyRepository)
